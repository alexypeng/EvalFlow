        ...
        <main className="min-h-screen bg-slate-100 px-5 py-8 text-slate-950">
            <div className="mx-auto max-w-6xl">
              ...
              slate-500"
                    ...
                    <span
                        className="rounded-full border border-slate-300 bg-white px-
            3 py-1 text-sm font-semibold text-slate-700"
                    >
                        Local MVP
                    </span>
                </header>
            ...
            bg-white p-5"
                    ...
                    <article
                        className="min-h-72 rounded-lg border border-slate-200
